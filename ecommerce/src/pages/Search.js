...
const Search = () => {
    ...
    const [prodList, setProdList] = useState(frequentlyPurchased)
    ...
    useEffect(()=>{
        ...
        if (inputValue) {
            ...
            frequentlyPurchased.map(item => {
                console.log("check", item.title, inputValue, item.title.toLowerCase().includes(inputValue.toLowerCase()))
                if (item.title.includes(inputValue)) {
                    newItemList.push(item)
                }
            })
            console.log("new", newItemList)
            setProdList(newItemList)
    ...
    return (
        <AppLayout >
            ...
            {isFilteredList && <div>filteted list</div>}
            <ProductGrid products={prodList} />
        </AppLayout>
    )
}
